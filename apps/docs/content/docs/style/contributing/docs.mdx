...
<Files>
  <Folder name="apps/docs" defaultOpen>
    <Folder name="content">
      <Folder name="docs">
        <Folder name="style" description="Style docs: installation, updating, theming, changelog" />
        <Folder name="api" description="Generated API docs for the Nitro API" />
      </Folder>
    </Folder>
    <Folder name="scripts" description="generate-docs, sync-changelog, lint helpers" />
    <Folder name="src" defaultOpen>
      <Folder name="app">
        <Folder name="(home)" description="Marketing homepage and its components" />
      ...
      <Folder name="lib" description="AI wiring, OpenAPI, metadata, page tree, etc" />
      <Folder name="styles" description="Tailwind entry CSS" />
