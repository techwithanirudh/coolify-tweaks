---
title: Style
description: Work on the Sass pipeline that produces `main.user.css`
icon: Palette
---
...
<Files>
  <Folder name="apps/style" defaultOpen>
    ...
    <Folder name="plugins">
      <Folder name="postcss" description="Custom PostCSS plugins (banner, theme identifier, moz wrapping)" />
    </Folder>
    <Folder name="scripts" description="Build and watch helpers" />
    <Folder name="src" defaultOpen>
      <Folder name="components" description="Component level styling (sidebar, cards, navbar, etc)" />
      <Folder name="pages" description="Page specific tweaks (deployments, resources, onboarding)" />
      ...
      <File name="main.scss" description="Entry point that includes everything" />
    </Folder>
