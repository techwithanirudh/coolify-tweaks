...
<Files>
  <Folder name="coolify-tweaks" defaultOpen>
    <Folder name="apps" defaultOpen>
      ...
      <Folder name="api" description="Nitro release proxy" />
...
3. Make changes and run the repo checks:
...
4. Push a branch with a Conventional Commit message, open a PR, and address any CI feedback.

## Apps

<Cards>
  <Card title="Style" href="/docs/development/apps/style" icon={<Palette />}>
    Sass + Lightning CSS pipeline that builds the Tweaks stylesheet.
    Produces both .user.css and standard CSS bundles.
  </Card>

<Card title="API" href="/docs/development/apps/api" icon={<Server />}>
  Nitro-based API for release proxying and serving final CSS bundles.
</Card>

<Card title="Docs" href="/docs/development/apps/docs" icon={<Book />}>
  Next.js + Fumadocs documentation and marketing site powered by @repo/ui.
</Card>

  <Card title="Tooling" href="/docs/development/apps/tooling" icon={<Settings />}>
