...
export function TestimonialsSection() {
  ...
  const testimonials = [
    {
      quote:
        "The improved spacing and colorwork make our Coolify dashboard feel so much more polished. It's like having a custom UI without any of the complexity.",
      name: "Jamie Marshall",
    ...
    {
      quote:
        "Coolify Tweaks has transformed our dashboard experience. The improved spacing and typography make everything so much more readable and professional.",
      name: "Sarah Chen",
    ...
    {
      quote:
        "Coolify Tweaks makes our dashboard feel intentional and polished. The subtle theming lifts the entire control plane without changing how things work.",
      name: "Marcus Rodriguez",
      company: "DevOps Lead, InnovateCorp",
      image:
      ...
      <div className="self-stretch px-2 overflow-hidden flex justify-start items-center bg-background border border-b border-l-0 border-r-0 border-t-0">
        <div className="flex-1 py-16 md:py-17 flex flex-col md:flex-row justify-center items-end gap-6">
          <div className="self-stretch px-3 md:px-12 justify-center items-start gap-4 flex flex-col md:flex-row">
            <img
              className="w-48 aspect-square md:w-48 rounded-lg object-cover transition-all duration-700 ease-in-out"
              style={{
            ...
            <div className="flex-1 px-6 py-6 shadow-[0px_0px_0px_0.75px_rgba(50,45,43,0.12)] overflow-hidden flex flex-col justify-start items-start gap-6 shadow-none pb-0 pt-0">
              <div
                className="self-stretch justify-start flex flex-col text-2xl md:text-[32px] font-medium leading-10 md:leading-[42px] font-sans overflow-hidden line-clamp-5 transition-all duration-700 ease-in-out tracking-tight"
                style={{
